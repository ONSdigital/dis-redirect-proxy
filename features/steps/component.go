...
//	}
//
//	c.fakeRedis = NewFakeRedis()
//	c.Config.RedisConfig.Address = c.fakeRedis.fakeHTTP.ResolveURL("")
//
//	c.Config.HealthCheckInterval = 1 * time.Second
//	c.Config.HealthCheckCriticalTimeout = 3 * time.Second
//
//	c.fakeRedis.healthRequest = c.fakeRedis.fakeHTTP.NewHandler().Get("/health")
